	...
	<body>
		...
		<div id="breadcrumb" class="section">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						<h3 class="breadcrumb-header">Đăng nhập${errorMessage}</h3>
					</div>
				</div>
				<!-- /row -->
			</div>
					...
					<div class="col-md-7">
						...
						<div class="billing-details">
							...
							<div class="form-group">
								<input class="input" type="text" id="username" name="username" placeholder="Tên đăng nhập">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<div class="input-checkbox">
									...
									<div class="caption">
										<p>Vui lòng nhập đầy đủ thông tin bên dưới để đăng ký</p>
										<div class="form-group">
											<input class="input" type="text" name=""password"" placeholder="Họ và tên">
										</div>
										<div class="form-group">
											<input class="input" type="email" name=""password"" placeholder="Email">
										</div>
										<div class="form-group">
											<input class="input" type="number" name=""password"" placeholder="Số điện thoại" maxlength="10">
										</div>
									</div>
								</div>
							</div>
							<input type="submit" value="Đăng nhập" class="primary-btn order-submit" tabindex="3">
						</form>
						</div>
						<!-- /Billing Details -->
					</div>
